...
class CollectionRun(Base):
    ...
    profiles_succeeded: Mapped[list] = mapped_column(JSONB, default=list)
    profiles_failed: Mapped[list] = mapped_column(JSONB, default=list)
    ...
    collaborations_found: Mapped[int] = mapped_column(Integer, default=0)
    collaborations_made: Mapped[int] = mapped_column(Integer, default=0)
    collaborations_received: Mapped[int] = mapped_column(Integer, default=0)
    ...
    profile_summaries: Mapped[list] = mapped_column(JSONB, default=list)
    report_payload: Mapped[dict] = mapped_column(JSONB, default=dict)
    profile_appearances: Mapped[int] = mapped_column(Integer, default=0)
    unique_views: Mapped[int] = mapped_column(BigInteger, default=0)
    internal_collaborations: Mapped[int] = mapped_column(Integer, default=0)
    external_collaborations: Mapped[int] = mapped_column(Integer, default=0)
