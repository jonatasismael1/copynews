...
export const Card=React.forwardRef<HTMLDivElement,React.HTMLAttributes<HTMLDivElement>>(({className,...p},r)=><div ref={r} className={cn('rounded-[var(--radius-card)] border bg-card text-card-foreground shadow-[0_1px_2px_rgb(16_24_40/4%)]',className)}{...p}/>);Card.displayName='Card'
